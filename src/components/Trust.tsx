...
export const Trust = () => {
    return (
        <section className="py-32 px-4 bg-white border-y border-neutral-100 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div>
                        ...
                        <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter leading-none">
                            Enterprise-Grade <br />
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-4 rounded-2xl bg-neutral-50 border border-neutral-100">
                                ...
                                <span className="text-sm font-bold text-[#2d2d2d] uppercase italic">Continuous Monitoring & Anomaly Detection</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {trustFactors.map((factor, i) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="p-8 rounded-[2.5rem] bg-neutral-50 border border-neutral-100 hover:border-primary/20 transition-all group"
                            >
                                <factor.icon className="w-8 h-8 text-primary mb-6 group-hover:scale-110 transition-transform" />
                                <h4 className="text-sm font-black text-[#2d2d2d] uppercase mb-4 tracking-tight">{factor.title}</h4>
                                <p className="text-xs text-neutral-500 font-medium leading-relaxed">{factor.description}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
