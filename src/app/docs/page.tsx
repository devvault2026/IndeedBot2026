...
export default function DocsPage() {
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* Header / Sub-nav */}
            <div className="pt-24 border-b border-neutral-100 sticky top-0 bg-white/80 backdrop-blur-md z-40">
                <div className="max-w-7xl mx-auto px-8 py-6 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        />
                        <div>
                            <h1 className="text-xl font-black italic uppercase tracking-tighter text-[#2d2d2d]">Knowledge base</h1>
                    ...
                    <div className="relative group hidden md:block">
                        ...
                        <input
                            ...
                            className="bg-neutral-50 border border-neutral-200 rounded-full py-2.5 pl-11 pr-6 text-sm font-medium w-80 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                            value={searchQuery}
            ...
            <div className="max-w-7xl mx-auto flex">
                {/* Sidebar */}
                <aside className="w-80 shrink-0 border-r border-neutral-100 h-[calc(100vh-140px)] sticky top-[140px] overflow-y-auto hidden lg:block p-8">
                                    ...
                                    {category.links.map((link) => (
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center justify-between group ${activeSection === link.id
                                                ...
                                                : 'text-neutral-500 hover:bg-neutral-50 hover:text-[#2d2d2d]'
                                                }`}
                                        >
                                            {link.name}
                        ...
                        >
                            {activeSection === "welcome" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">What is IndeedBot?</h2>
                            ...
                            {activeSection === "how-it-works" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">How it Works (Simple)</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        ...
                                        <div className="space-y-10">
                                            <div className="flex gap-8">
                                                ...
                                                <div>
                                                    <h4 className="text-xl font-bold text-[#2d2d2d] mb-2 uppercase">The Scout (Signals)</h4>
                                            ...
                                            <div className="flex gap-8">
                                                <div className="shrink-0 w-12 h-12 rounded-2xl bg-neutral-100 text-neutral-400 flex items-center justify-center font-black italic">2</div>
                                                <div>
                                                    <h4 className="text-xl font-bold text-[#2d2d2d] mb-2 uppercase">The Brain (Reasoning)</h4>
                                            ...
                                            <div className="flex gap-8">
                                                <div className="shrink-0 w-12 h-12 rounded-2xl bg-neutral-100 text-neutral-400 flex items-center justify-center font-black italic">3</div>
                                                <div>
                                                    <h4 className="text-xl font-bold text-[#2d2d2d] mb-2 uppercase">The Architect (Design)</h4>
                            ...
                            {activeSection === "who-it-is-for" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">Who is this for?</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="p-8 rounded-[2.5rem] bg-neutral-900 text-white">
                                            ...
                                            <div className="p-8 rounded-[2.5rem] bg-neutral-100">
                                                <h4 className="text-sm font-black text-[#2d2d2d] uppercase tracking-[2px] mb-4">Tech-Savvy Changers</h4>
                            ...
                            {activeSection === "quickstart" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">Quick Start</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        <div className="space-y-12">
                                            <div className="relative pl-12 border-l-2 border-neutral-100">
                                                <h4 className="text-xl font-bold text-[#2d2d2d] mb-4 uppercase">1. Install the Extension</h4>
                                            ...
                                            <div className="relative pl-12 border-l-2 border-neutral-100">
                                                <h4 className="text-xl font-bold text-[#2d2d2d] mb-4 uppercase">2. Add your API Key</h4>
                                            ...
                                            <div className="relative pl-12 border-l-2 border-neutral-100">
                                                <h4 className="text-xl font-bold text-[#2d2d2d] mb-4 uppercase">3. Start Browsing</h4>
                            ...
                            {activeSection === "deepseek-setup" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">Connecting DeepSeek</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        ...
                                        <div className="bg-neutral-50 p-10 rounded-[3rem] border border-neutral-200">
                            ...
                            {activeSection === "analyzing" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">Analyzing Job Posts</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        ...
                                        <div className="space-y-8">
                                            <div className="p-8 border border-neutral-200 rounded-3xl">
                                                <h4 className="text-sm font-black text-[#2d2d2d] uppercase mb-2">The Pulse Window</h4>
                                            ...
                                            <div className="p-8 border border-neutral-200 rounded-3xl">
                                                <h4 className="text-sm font-black text-[#2d2d2d] uppercase mb-2">The Signal Panel</h4>
                            ...
                            {activeSection === "scoring" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">Understanding Scores</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        <div className="space-y-6">
                                            {[
                                                ...
                                                <div key={i} className="p-6 bg-neutral-50 rounded-2xl border border-neutral-100">
                                                    <h4 className="text-sm font-black text-[#2d2d2d] uppercase mb-1">{item.label}</h4>
                            ...
                            {activeSection === "executive" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">Executive Strategy</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        ...
                                        <div className="space-y-8">
                                            <div className="p-8 bg-neutral-100 rounded-[2rem]">
                            ...
                            {activeSection === "engineering" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">System Blueprint</h2>
                                    <div className="prose prose-neutral max-w-none">
                            ...
                            {activeSection === "troubleshoot" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">Troubleshooting</h2>
                                    <div className="prose prose-neutral max-w-none">
                                        <div className="space-y-6">
                                            <div className="p-8 border border-neutral-200 rounded-3xl">
                                                <h4 className="text-lg font-bold text-[#2d2d2d] uppercase italic mb-2">Bot doesn't show up?</h4>
                                            ...
                                            <div className="p-8 border border-neutral-200 rounded-3xl">
                                                <h4 className="text-lg font-bold text-[#2d2d2d] uppercase italic mb-2">"Thinking" but no text?</h4>
                            ...
                            {activeSection === "json-pack" && (
                                <>
                                    ...
                                    <h2 className="text-4xl md:text-5xl font-black italic mb-8 text-[#2d2d2d] uppercase tracking-tighter">AI Knowledge Pack</h2>
                                    <div className="prose prose-neutral max-w-none">
                            ...
                            <div className="mt-32 pt-8 border-t border-neutral-100 flex items-center justify-between">
                                ...
                                <div className="flex gap-4">
                                    <button className="px-6 py-2.5 rounded-xl text-xs font-black uppercase text-neutral-400 border border-neutral-100 hover:bg-neutral-50 transition-colors">Previous</button>
